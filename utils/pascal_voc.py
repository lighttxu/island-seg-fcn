...
def pascal_segmentation_lut(num):
    ...
    """
    if num == 21:
        class_names = ['background', 'aeroplane', 'bicycle', 'bird', 'island',
                       'bottle', 'bus', 'car', 'cat', 'chair', 'cow', 'diningtable',
                       'dog', 'horse', 'motorbike', 'person', 'potted-plant',
                       'sheep', 'sofa', 'train', 'tv/monitor', 'ambigious']
    if num == 2:
        class_names = ['background', 'island', 'ambigious']
...
def get_pascal_segmentation_image_annotation_filenames_pairs(pascal_root,filetype):
...
def get_pascal_selected_image_annotation_filenames_pairs(pascal_root, selected_names,filetype):
...
def get_augmented_pascal_image_annotation_filename_pairs(pascal_root, pascal_berkeley_root, mode=1,filetype='jpg'):
...
#        validation = pascal_val_name_set - all_berkeley
    ...
    train_from_pascal_image_annotation_pairs = get_pascal_selected_image_annotation_filenames_pairs(pascal_root,list(train_from_pascal),filetype)

    overall_train_image_annotation_filename_pairs = train_from_pascal_image_annotation_pairs

    overall_val_image_annotation_filename_pairs = get_pascal_selected_image_annotation_filenames_pairs(pascal_root,validation,filetype)

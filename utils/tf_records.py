...
def write_image_annotation_pairs_to_tfrecord(filename_pairs, tfrecords_filename, filetype='png'):
    ...
    if filetype == 'jpg' or filetype == 'png':
        for img_path, annotation_path in filename_pairs:
            if img_path != '/home/shou/network/island/JPEGImages/.jpg' and  annotation_path != '/home/shou/network/island/SegmentationClass/.png':
    ...
    if filetype == 'tif':
        for img_path, annotation_path in filename_pairs:
            if img_path != '/home/shou/tif/JPEGImages/.tif':

                tif1 = tiff.imread(img_path).transpose([1, 2, 0])
                img = np.array(tif1)
                annotation = np.array(Image.open(annotation_path))
                # Unomment this one when working with surgical data
                # annotation = annotation[:, :, 0]
